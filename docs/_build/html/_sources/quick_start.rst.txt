...
The default language for this Project is **English**, and we use internationalization to translate the text into Hungarian.
...
change the language "hu" for your selected language.

Next, go to the locale folder of your language::

    $ cd taskbuster/locale/hu/LC_MESSAGES
...
Once the translation is done, compile your messages with::
    ...
    $ python manage.py compilemessages -l hu
